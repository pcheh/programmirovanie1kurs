...
namespace task_6._3
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (!AreFiguresPositionsCorrect(whiteQueenPosition, blackPawnPosition))
            {
            ...
            if (CanQueenMakeSafeMove(whiteQueenPosition, blackPawnPosition, move))
        ...
        static bool AreFiguresPositionsCorrect(string queenPosition, string pawnPosition)
        {
            return !IsEqualPositions(queenPosition, pawnPosition) &&
                IsPawnPositionCorrect(pawnPosition) &&
                !DoesQueenStrikePawn(queenPosition, pawnPosition) &&
                !DoesPawnStrikeQueen(queenPosition, pawnPosition);
        }

        static bool CanQueenMakeSafeMove(string queenPosition, string pawnPosition, string move)
        {
            return CanQueenMove(queenPosition, move) &&
                !DoesPawnStrikeQueen(move, pawnPosition);
        }
        ...
        static bool DoesPawnStrikeQueen(string queenPosition, string pawnPosition)
        {
            int qx, qy, px, py;
        ...
        static bool DoesQueenStrikePawn(string queenPosition, string pawnPosition)
        {
            return CanQueenMove(queenPosition, pawnPosition);
        }
        ...
        static bool CanQueenMove(string queenPosition, string move)
        {
            int qx, qy, mx, my;
            GetCoordinates(queenPosition, out qy, out qx);
